    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    {{--@include('errors.note')--}}
                    <form class="form-create" method="post" action="{{route('editpost',$data->id)}}" enctype="multipart/form-data">
                        <div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
                            <label>Tiêu đề bài viết</label>
                            <input  type="text" class="form-control" placeholder="Tên danh mục" name="title" value="{{$data->title}}">
                            <span class="text-error">{{$errors->first('name')}}</span>
                        </div>
                        <div class="form-group {{$errors->has('alias') ? 'has-error' : ''}}">
                            <label>Mô tả bài viết</label>
                            <input  type="text" class="form-control" placeholder="Tên không dấu" name="description" value="{{$data->description}}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="ckeditor" name="main_content">{{$data['main_content']}}</textarea>
